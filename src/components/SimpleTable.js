              ...
              <TableCell style={{ fontSize: 18, textAlign: 'left' }}>
                {row.links.homepage !== row.links.repository ? (
                  <div
                    ...
                    onClick={openInNewTab(row.links.homepage)}
                ...
                {row.links.repository ? (
                  <div
                    style={{ marginLeft: 5, color: 'black', textDecoration: 'underline', cursor: 'pointer' }}
                    onClick={openInNewTab(row.links.repository)}
                    rel="noopener noreferrer"
                  >
